<?php require_once('konfiguralas.php') ?>
<?php require_once('belso/nyilvanos_fuggvenyek.php') ?>
<?php require_once('belso/interakcio_muveletek.php') ?>
<!-- Összes hozzászólás lekérése az adatbázisból  -->
<?php $bejegyzesek = getKozzetettBejegyzesek() ?>
<?php require_once('belso/fejlec.php') ?>
